        ...
        <div class="row justify-content-center">
            <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10">
                ...
                <ul class="nav nav-tabs mb-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active bg-primary text-white" aria-current="page" href="{{ route('restaurants.reservations.create', $restaurant) }}">予約</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="reservation_time" name="reservation_time">
                                ...
                                @for ($i = 0; $i <= (strtotime($reservation_time_end) - strtotime($reservation_time_start)) / 60 / $time_unit; $i++)
                                    {{ $reservation_time = date('H:i', strtotime($reservation_time_start . '+' . $i * $time_unit . 'minute')) }}
